...
module.spells.descriptions = {
	...
	["hereticrigevent"] = rig .. "Heretic Riget. Ha aktiválják, a rálépett játékos meg lesz szállva. A játékosnak Manát kell találnia, hogy fel legyen szabadítva. A megszállott játékosok nem varázsolhatnak, és nem ugorhatnak. Ha rendelkezel UNBELIEVER ranggal, akkor immunis leszel a Heretic rigre. Ha rendelkezel EXILED ranggal, akkor kapsz 1 Manát amikor egy játékost megszállnak.",
	...
	["spliceraltevent"] = event .. "lépcsőt előrefelé kettéhasítja.",
