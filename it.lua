...
module.spells.descriptions = {
	...
	["keeperevent"] = event .. "Spostamento Randomico. Questo sortilegio ha due modalità: Leggera e Forzata. La differenza giace nel fatto che la seconda distruggerà eventuali scale in mezzo.",
