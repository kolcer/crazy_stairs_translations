...
module.gui.menu = {
	...
	["Stats"] = "Statistiche e riconoscimenti",
...
module.spells.names = {
	...
	["archsplicer"] = "Combina o Taglia Scale",
...
module.spells.descriptions = {
	...
	["archsplicer"] = "Taglia la scala nella direzione indicata o combina la scala colpita con un'altra a tua scelta.",
...
module.static = {
	...
	["vr_1"] = "Quando accedi a ScaleMania in Realtà Virtuale, giocherai come Architect.",
	...
	["vr_6"] = "Usa il joystick destro per muoverti in alto e basso. Inclinandolo di lato puoi muovere la visuale di circa 55°.",
...
module.guide = {
	...
	["both"] = {
		...
		["archsplicer"] = "Taglia Scale/Combina Scale",
...
module.serverfeedback = {
	...
	["notinreg"] = "La rigenerazione è attiva!",
	...
	["nodronespin"] = "I Droni NON possono ruotare le scale in modalità di default.",
	["noinput"] = "Inserisci un valore!",
	["nonumber"] = "Inserisci un numero!",
	["notrace"] = "Gara in corso, impossibile aggiornare il numero di piani!",
	["notultimate"] = "Sortilegio in esecuzione, impossibile aggiornare il numero di piani!",
	["notregen"] = "Rigenerazione in corso, impossibile aggiornare il numero di piani!",
	["wait"] = "La torre sta subendo cambiamenti, attendi qualche secondo...",
	...
	["cooldown"] = "Tempo di ricarica per i sortilegi e rig modificato.",
	["speed"] = "Velocità dei Droni modificata.",
	["spin"] = "Durata intervalli tra gli incantesimi dei Droni modificata.",
	["max"] = "Limite massimo di scale aggiornato.",
...
module.serverbroadcast = {
	...
	["trap"] = "%s è caduto nella trappola di %s.",
	["obby"] = "%s si sta arrampicando sulle scale frantumate da %s.",
