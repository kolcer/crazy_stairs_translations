...
module.gui.shop = {
	...
	["chameleon"] = "Chameleon có thể thay đổi alignment khi leo tháp.",
	["spectre"] = "Spectre Là 1 alignment dựa vào dịch chuyển tức thời tốt nhất cho chơi solo.",
...
module.spells.names = {
	...
	["flatten"] = "Uốn Thang Đối Diện Xuống",
	["wall"] = "Tạo Tường" ,
